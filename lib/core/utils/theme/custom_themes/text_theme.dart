...
class AppTextTheme {
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    displayLarge: const TextStyle().copyWith(fontSize: 42, fontWeight: FontWeight.bold, color: Colors.black),
    ...
    labelSmall: const TextStyle().copyWith(fontSize: 10.0, fontWeight: FontWeight.normal, color: Colors.black.withOpacity(0.5)),
  ...
  static TextTheme darkTextTheme = TextTheme(
    ...
    labelSmall: const TextStyle().copyWith(fontSize: 10.0, fontWeight: FontWeight.normal, color: Colors.white.withOpacity(0.5)),
